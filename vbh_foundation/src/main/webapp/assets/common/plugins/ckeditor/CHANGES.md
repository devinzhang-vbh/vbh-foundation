...
* [#13816](https://dev.ckeditor.com/ticket/13816): Introduced a new foundation for Filling Character handling to avoid changes in DOM. This fixes the following issues:
