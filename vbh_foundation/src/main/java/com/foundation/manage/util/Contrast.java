...
import com.foundation.manage.common.constant.dictmap.factory.DictFieldWarpperFactory;
    ...
    public static String contrastObjByName(Class dictClass, String key, Object pojo1, Map<String, String> pojo2) throws IllegalAccessException, InstantiationException {
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                String prefix = "get";
                int prefixLength = 3;
                String booleanString = "java.lang.Boolean";
                if (booleanString.equals(field.getType().getName())) {
                    prefix = "is";
                    prefixLength = 2;
                }
